...
<template>
  <div class="flex h-full bg-white dark:bg-gray-900 overflow-hidden rounded-xl border border-gray-200 dark:border-gray-800">
    ...
    <div class="w-60 shrink-0 border-r border-gray-200 dark:border-gray-800 flex flex-col hidden md:flex self-start sticky top-0 max-h-screen">
    ...
    >
      <div class="max-w-3xl mx-auto space-y-16">
        ...
        <section
          ...
          class="space-y-6 scroll-mt-8"
        >
          <h2 class="text-2xl font-bold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-800 pb-2">
            Authentication
          </h2>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
              ...
              <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
                Used for CRUD operations on videos and libraries. Keep strictly on your server.
              </p>
            ...
            <div class="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
              ...
              <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">
                Used by your backend to sign video URLs. Never expose this to the frontend.
              </p>
            </div>
          </div>
        </section>
        ...
        >
          <h2 class="text-2xl font-bold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-800 pb-2">
            Embed Player (Lightweight & Standalone)
          </h2>
...
&gt;&lt;/iframe&gt;</code></pre>
        ...
        <section
          id="api"
          class="space-y-6 scroll-mt-8 pb-16"
        >
          <h2 class="text-2xl font-bold text-gray-900 dark:text-white border-b border-gray-200 dark:border-gray-800 pb-2">
            REST API Reference
          </h2>
