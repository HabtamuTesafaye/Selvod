...
<template>
  <div class="mt-8 flex flex-col sm:flex-row items-center justify-between gap-4 pt-6 border-t border-slate-200 dark:border-[#2d3139]">
    <div class="flex items-center gap-3 text-sm text-slate-500 dark:text-slate-400">
      ...
      <select
        :value="itemsPerPage"
        class="px-2 py-1 bg-white dark:bg-[#1a1d24] border border-slate-200 dark:border-[#2d3139] rounded-md text-xs cursor-pointer text-slate-700 dark:text-slate-300 focus:outline-none focus:ring-1 focus:ring-primary"
